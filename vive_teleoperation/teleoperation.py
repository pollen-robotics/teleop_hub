...
class Teleoperation:
    ...
    def manage_mode(self):
        ...
        if MODE == RIGHT_ARM or MODE == LEFT_ARM:
            ...
            if self.controllers[MODE].buttonA == 0 and self.controllers[MODE].buttonA != self.controller_previous_button[MODE][1]:
                print("Change mode")
                if self.mode == 1:
                    self.mode = 0
                else:
            ...
            if self.controllers[MODE].joystick_button == 0 and self.controllers[MODE].joystick_button != self.controller_previous_button[MODE][0]:
                print("Change joystick mode")
            ...
            self.controller_previous_button[MODE] = [self.controllers[MODE].joystick_button, self.controllers[MODE].buttonA, self.controllers[MODE].buttonB]
                ...
                if MODE == DUAL_ARM:
                    if self.mode == 2:
                        ...
                        if self.joystick_mode[RIGHT_ARM] == 0:
                            _ , r_y = self.joystick_to_mobile_base(self.controllers[RIGHT_ARM].joystick_x, self.controllers[RIGHT_ARM].joystick_y)
                            theta = r_y * 100
                        ...
                        if self.joystick_mode[LEFT_ARM] == 0:
                            x, y = self.joystick_to_mobile_base(self.controllers[LEFT_ARM].joystick_x, self.controllers[LEFT_ARM].joystick_y)
                        else:
