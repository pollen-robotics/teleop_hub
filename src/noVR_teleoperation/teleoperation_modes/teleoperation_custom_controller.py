...
import numpy as np
from controllers.custom_controller import CustomController  # type: ignore
from teleoperation_modes.teleoperation_base import (  # type: ignore
    DUAL_ARM,
    LEFT_ARM,
    RIGHT_ARM,
    Teleoperation,
...
class CustomControllerTeleoperation(Teleoperation):
    ...
    def _init_controllers(self) -> None:
        ...
        if self.control_mode == DUAL_ARM:
            self.controllers = {
                LEFT_ARM: CustomController(self.tracker_type, LEFT_ARM, self.camera),
                RIGHT_ARM: CustomController(self.tracker_type, RIGHT_ARM, self.camera),
            }
        else:
            self.controllers = {
                self.control_mode: CustomController(self.tracker_type, self.control_mode, self.camera),
            }
    ...
    def _handle_stop_button(self, controller: CustomController) -> None:
        ...
        Args:
            controller (CustomController): The controller to check for the stop button.
        """
    ...
    def _handle_mode_toggle(self, controller: CustomController) -> None:
        ...
        Args:
            controller (CustomController): The controller to check for the mode toggle button.
        """
    ...
    def _handle_mode_set(self, controller: CustomController) -> None:
        """Set the mode (switched by a press of the buttonA).
        Args:
            controller (CustomController): The controller to check for the buttonA state.
        """
    ...
    def _handle_joystick_toggle(self, controller: CustomController, single_arm: bool = False) -> None:
        ...
        Args:
            controller (CustomController): The controller to check for the joystick toggle button.
    ...
    def _update_previous_buttons(self, controller: CustomController) -> None:
        ...
        Args:
            controller (CustomController): The controller to update the previous button states for.
        """
